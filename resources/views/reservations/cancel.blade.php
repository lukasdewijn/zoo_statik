        ...
        <div class="mx-auto w-full max-w-5xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="rounded-2xl bg-white shadow-lg p-6 flex flex-col justify-between">
                    ...
                    <div>
                        <h1 class="text-3xl font-extrabold text-gray-900 mb-4">Reservatie annuleren</h1>
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-6">
                            ...
                            <div class="rounded-xl bg-gray-50 p-3">
                                ...
                                <p class="mt-0.5 text-base font-bold text-gray-900">{{ $reservation->status->value }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    @if ($reservation->status !== App\Enums\ReservationStatus::Cancelled)
                        <form method="POST" action="{{ $cancelUrl }}">
                            @csrf
                            <button class="w-full rounded-xl bg-red-600 px-6 py-3 font-bold text-white shadow-md transition hover:bg-red-700 hover:shadow-lg focus:ring-2 focus:ring-red-300 focus:ring-offset-2">
                                Bevestig annuleren
                            </button>
                        </form>
                    @endif
                ...
                <div class="overflow-hidden rounded-2xl bg-white shadow-lg flex flex-col">
                    <div class="relative flex-1">
                        ...
                        <p class="absolute top-6 left-6 right-6 text-2xl font-extrabold text-white drop-shadow-lg leading-tight">
                            Are you really gonna cancel our date?
                        </p>
                    </div>
                </div>
